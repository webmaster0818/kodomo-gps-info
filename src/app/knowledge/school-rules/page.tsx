...
const faqData = [
  ...
  { q: 'GPSをこっそり持たせたら学校にバレますか？', a: '音や光が出ない位置情報専用のGPS端末は、ランドセルに入れたままなら日常的に気づかれることはまずありません。ただし持ち物検査や紛失時にトラブルになる可能性があるため、当サイトでは無断で持たせるのではなく、本ページの例文を使って事前に学校へ確認・申請することをおすすめします。多くの学校で正規に許可される持ち物です。' },
