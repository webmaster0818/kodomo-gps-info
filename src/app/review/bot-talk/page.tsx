...
export default function BotTalkPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Product", "name": "BoTトーク", "brand": {"@type": "Brand", "name": "ビーサイズ"}, "review": {"@type": "Review", "author": {"@type": "Person", "name": "GPS見守りナビ編集部"}}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.4", "bestRating": "5", "worstRating": "1", "ratingCount": "1"}}) }} />
