...
const faqData = [
  { q: 'みてねみまもりGPSの実際の口コミはどこで読めますか？', a: '楽天市場など販売ページのレビュー欄で購入者の実際の口コミが読めます。機種(MG05/トーク/トークPlus)によって機能が異なるため、口コミがどの機種への投稿かを確認してから参考にするのがおすすめです。当ページは公式の料金・仕様(確認日つき)のみで整理し、口コミの転載・創作はしていません。' },
