...
const faqData = [
  { q: 'イマドコサーチの口コミで多い不満は何に注意すればいいですか？', a: '検索のたびに操作が必要な「都度検索型」である点と、専用GPS端末型と比べた位置更新の間隔は、口コミを読む際の要注目ポイントです。常時追跡型(みてね・あんしんウォッチャー等の専用端末)とは仕組みが異なるため、比較検討する場合は当サイトの比較ページで方式の違いから確認するのがおすすめです。' },
