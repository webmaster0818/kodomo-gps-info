...
const faqData = [
  { q: 'あんしんウォッチャーの実際の口コミはどこで読めますか？', a: '楽天市場など販売ページのレビュー欄で購入者の実際の口コミを読めます。口コミを読む際は「電池持ち」「位置のズレ」「通知の速さ」への言及が、通学見守りという用途に直結する判断材料になります。当ページでは口コミの転載・創作はせず、公式一次情報(料金・仕様)を確認日つきで整理しています。' },
