...
export default function MamosearchPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Product", "name": "まもサーチ", "brand": {"@type": "Brand", "name": "BBソフトサービス"}, "review": {"@type": "Review", "author": {"@type": "Person", "name": "GPS見守りナビ編集部"}}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.2", "bestRating": "5", "worstRating": "1", "ratingCount": "1"}}) }} />
