...
const faqData = [
  { q: '子供用GPS端末で一番安いのはどれ？', a: '月額料金が最も安いのはconecoの月額480円（税込）です。次いでみてねみまもりGPS、BoTトーク、はろここが月額528円で並びます。' },
...
export default function CheapPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "子供GPS 安い順ランキング", "datePublished": "2026-03-15", "dateModified": "2026-05-27", "author": {"@type": "Person", "name": "GPS見守りナビ編集部"}, "publisher": {"@type": "Organization", "name": "GPS子供見守り最新情報"}}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "ホーム", "item": "https://gps-kodomo.com/"}, {"@type": "ListItem", "position": 2, "name": "目的別", "item": "https://gps-kodomo.com/purpose/"}, {"@type": "ListItem", "position": 3, "name": "安い・コスパ重視", "item": "https://gps-kodomo.com/purpose/cheap/"}]}) }} />
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ['4', 'はろここ', '528円', '5,280円', '11,616円', '/review/halococo/'],
                  ['5', 'あんしんウォッチャー', '539円', '5,680円', '12,148円', '/review/anshin-watcher/'],
                  ['6', 'soranome', '539円', '9,020円', '15,488円', '/review/soranome/'],
                  ['7', 'まもサーチ', '539円', '5,280円', '11,748円', '/review/mamosearch/'],
                  ['8', 'みもり', '748円', '8,580円', '17,556円', '/review/mimori/'],
                  ['9', 'BoTトーク（トーク付）', '748円', '5,280円', '14,256円', '/review/bot-talk/'],
                  ['10', 'Hamic', '1,100円', '12,100円', '25,300円', '/review/hamic/'],
                  ['11', 'SayuU', '1,210円', '13,200円', '27,720円', '/review/sayuu/'],
                  ['12', 'myFirst Fone', '約980円〜', '約18,000円〜', '約29,760円〜', '/review/myfirst-fone/'],
