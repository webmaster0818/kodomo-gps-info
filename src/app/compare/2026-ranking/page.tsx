...
export const metadata: Metadata = {
  title: '【2026年最新】子供用GPSおすすめランキング15選｜全機種比較',
  description:
    '2026年最新の子供用GPSおすすめランキング15選。精度・バッテリー・機能・料金・使いやすさの5軸で全機種を徹底評価。初期費用・月額・防水・通知機能の比較表、目的別おすすめ、選び方ガイドまで完全網羅。',
  keywords: ['子供GPS', 'おすすめ', 'ランキング', '2026', '比較', '全機種', '最新'],
  openGraph: {
    title: '【2026年最新】子供用GPSおすすめランキング15選｜全機種比較',
    description: '2026年最新の子供用GPSおすすめランキング15選。精度・バッテリー・機能・料金・使いやすさの5軸で全機種を徹底評価。',
  },
};
...
const faqData = [
  ...
  { q: '月額料金が一番安いGPSはどれ？', a: 'みてねみまもりGPS（月額528円）、どこかなGPS2（月額528円）、まもサーチ（月額528円）が最安クラスです。いずれも位置確認・ジオフェンス・SOS通知の基本機能を備えており、コスパ重視なら十分な性能です。' },
...
const rankingData = [
  ...
  {
    rank: 4, name: 'どこかなGPS2', score: 88, initial: 7480, monthly: 528,
    battery: '最大1.5ヶ月', waterproof: 'IP67', weight: '約60g', carrier: 'ソフトバンク LTE',
    notifications: 'ジオフェンス/SOS/バッテリー低下/定時',
    merit: 'IP67の防水防塵で雨や砂場に強い。みちびき（準天頂衛星）対応で日本国内の精度が高い。',
    demerit: '初期費用がやや高め。アプリの機能はシンプル。',
    recommend: '防水性能を重視する方、アウトドア活動が多いお子さん',
    review: '/review/dokokana/',
  },
  {
    rank: 5, name: 'まもサーチ', score: 87, initial: 5280, monthly: 528,
  ...
  {
    rank: 6, name: 'soranome（ソラノメ）', score: 85, initial: 9020, monthly: 539,
  ...
  {
    rank: 7, name: 'myFirst Fone R2', score: 84, initial: 26980, monthly: 998,
  ...
  {
    rank: 8, name: 'coneco（コネコ）', score: 82, initial: 8580, monthly: 748,
  ...
  {
    rank: 9, name: 'キッズフォン3', score: 81, initial: 20880, monthly: 539,
  ...
  {
    rank: 10, name: 'Hamic POCKET（ハミックポケット）', score: 79, initial: 12100, monthly: 1100,
  ...
  {
    rank: 11, name: 'ミモリ', score: 78, initial: 7480, monthly: 748,
  ...
  {
    rank: 12, name: 'ハロここ', score: 77, initial: 6380, monthly: 580,
  ...
  {
    rank: 13, name: 'あんしんウォッチャー LE', score: 75, initial: 5980, monthly: 539,
  ...
  {
    rank: 14, name: 'まもサーチ ミニ', score: 74, initial: 3980, monthly: 528,
  ...
  {
    rank: 15, name: 'みもりGPS ライト', score: 72, initial: 4980, monthly: 528,
...
const purposeRecommendations = [
  ...
  },
  {
    ...
    picks: [
      ...
      { name: 'どこかなGPS2', reason: '最大1.5ヶ月。IP67防水も兼ね備える。' },
    ],
  },
  {
    purpose: '通話機能付き',
    ...
    <>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <h2 className="section-title">総合ランキング 1〜15位</h2>
          ...
          <div className="card-hover p-6 mb-8">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: '防水性能を重視しますか？', yes: 'どこかなGPS2（IP67）がおすすめ', no: '次の質問へ' },
