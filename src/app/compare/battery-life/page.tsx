...
const batteryData = [
  ...
  { name: 'GPS BoT / BoTトーク', slug: '/review/bot-talk/', battery: '最大約1ヶ月', type: '位置情報（トーク版あり）', note: 'トーク機能を使うと消費は増える。' },
...
const faqData = [
  { q: '電池持ちが一番いい子供GPSは？', a: '位置情報専用のあんしんウォッチャーとみてねみまもりGPSが「最大約2ヶ月」で最長クラスです。次いでまもサーチやGPS BoTが約1ヶ月。一方、通話やメッセージができるキッズスマホ型（Hamic）やスマートウォッチ型（myFirst Fone）は数日で、ほぼ毎日の充電が必要です。' },
